...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-6xl mx-auto">
        ...
        <a href="{{ route('docente.postulaciones-actividad.index') }}"
           class="inline-block bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold py-2 px-4 rounded-lg transition mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach($carreras as $carrera)
                <a href="{{ route('docente.actividades-vinculacion.show', $carrera->id) }}"
                   class="block bg-white rounded-lg shadow-lg overflow-hidden hover:-translate-y-1 hover:shadow-xl transition-all duration-200">
