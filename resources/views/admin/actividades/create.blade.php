<x-app-layout>
    ...
    <div>
        ...
        <div class="ui-wrap" style="max-width: 1100px;">
            <x-ui.hero :volver="route('admin.actividades.index')" volver-texto="Actividades" titulo="Nueva actividad" subtitulo="Crea una actividad dentro de un proyecto. Los estudiantes podrán inscribirse desde «Proyectos disponibles»." />

            <div class="actividad-layout">
                <div class="bg-white shadow rounded-lg p-6 sm:p-8">
                <form action="{{ route('admin.actividades.store') }}" method="POST" data-confirm-title="¿Guardar este registro?" data-confirm-text="Revisa que los datos sean correctos." data-confirm-button="Sí, guardar">
                    @csrf
