    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow rounded-lg p-6">
                <form action="{{ route('admin.actividades.update', $actividad) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <select name="inscripcion_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            ...
                            @foreach ($inscripciones as $inscripcion)
                                <option value="{{ $inscripcion->id }}" {{ old('inscripcion_id', $actividad->inscripcion_id) == $inscripcion->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="fecha" value="{{ old('fecha', $actividad->fecha->format('Y-m-d')) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="lugar" value="{{ old('lugar', $actividad->lugar) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="descripcion" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('descripcion', $actividad->descripcion) }}</textarea>
                        @error('descripcion') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium text-sm text-gray-700">Horas</label>
                        <input type="number" step="0.5" min="0.5" max="24" name="horas" value="{{ old('horas', $actividad->horas) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="estado" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            ...
                            <option value="rechazada" {{ old('estado', $actividad->estado) == 'rechazada' ? 'selected' : '' }}>Rechazada</option>
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="comentario_docente" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('comentario_docente', $actividad->comentario_docente) }}</textarea>
